...
export default {
  menu: {
    ...
    proposal: "Proposals",
    tokens: "Tokens",
    erc20Tokens: "Trn20 Hot Tokens",
    erc20Transfer: "Trn20 Transfers",
    erc721Tokens: "Trn721 Hot Tokens",
    erc721Transfer: "Trn721 Transfers",
  ...
  footer: {
    desc: "PlatScan is a Block Explorer and Analytics Platform for ",
    links: "Links",
    help: "Help",
    wallet: "Wallet",
  ...
  tokens: {
    ...
    typeErc20Token: "Types 20 Tokens",
    typeErc721Token: "Types 721 Tokens",
    typeErc1155Token: "Types 1155 Tokens",
    tokens: "Tokens",
    tokenID: "TokenID",
    erc20Tokens: "20 TOKENS",
    erc721Tokens: "721 TOKENS",
    erc1155Tokens: "1155 TOKENS",
    ...
    erc20TokenTxns: "20 Token Txns",
    erc721TokenTxns: "721 Token Txns",
    erc1155TokenTxns: "1155 Token Txns",
    number: "quantity",
  ...
  contract: {
    ...
    erc20Trade: "20 Token Txns",
    erc721Trade: "721 Token Txns",
    erc1155Trade: "1155 Token Txns",
  ...
  indexInfo: {
    WelcomeTo: "Welcome to {chain} Blockchain Explorer",
  ...
  TxType: {
    ...
    4: "Others", //其他
    5: "MPCTx", //'MPC交易',
    6: "20 ContractCreation", //erc20合约创建
    7: "20 ContractExecution", //erc20合约执行
    8: "721 ContractCreation", //erc721合约创建
    9: "721 ContractExecution", //erc721合约执行
    10: "1155 ContractCreation", //erc1155合约创建
    11: "1155 ContractExecution", //erc1155合约执行
  ...
  more: {
    ...
    increaseIssuanceRatio: "network's fixed annual issuance ratio of TURN(‱).",
  ...
  fund: {
    ...
    totalBalance: "Total Balance (TURN)",
    totalLocked: "Total LockupBalance (TURN)",
    pageTotal: `Totally <b class="black">{0}</b> addresses`,
    tAddress: "Address",
    tBalance: "Balance (TURN)",
    tLockedBalance: "Lockup Balance (TURN)"
  },
  ...enLocale,
  microNode: {
    name: "Micro Node",
    ...
    searchValidator: "Please enter node name/ID to query",
