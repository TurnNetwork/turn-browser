...
export default {
  menu: {
    ...
    proposal: "治理提案",
    tokens: "令牌",
    erc20Tokens: "AARC20热门令牌",
    erc20Transfer: "AARC20 交易",
    erc721Tokens: "AARC721热门令牌",
    erc721Transfer: "AARC721 交易",
  ...
  more: {
    ...
    stakeThreshold: "创建验证节点最低的质押AA数。",
    operatingThreshold: "委托用户每次委托或赎回委托的最低AA数。",
    ...
    increaseIssuanceRatio: "网络的AA每年增发比例（‱）。",
