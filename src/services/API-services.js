...
class ApiService {
  constructor() {
    ...
    this.search = {
      ...
      queryLayerTwo: this.post.bind(this, API.SEARCH.queryLayerTwo),
    ...
    this.micro_node = {
      statistic: this.post.bind(this, API.MICRO_NODE.statistic),
      aliveNodeList: this.post.bind(this, API.MICRO_NODE.aliveNodeList),
      details: this.post.bind(this, API.MICRO_NODE.details),
      microNodeOptRecordList: this.post.bind(this, API.MICRO_NODE.microNodeOptRecordList),
    };
    this.more = {
