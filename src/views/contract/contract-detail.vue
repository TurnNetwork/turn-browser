          ...
          <div class="others overview">
            ...
            <ul>
              <li>
                ...
                <!-- 系统合约 -->
                <div class="money">{{ detailInfo.tokenName }}</div>
...
<!--                <div class="money" v-else>Not Available</div>-->
              ...
              <li>
                ...
                <div v-else class="money contract-create-info">
                  <router-link class="normal ellipsis adr-width" :to="getAddressUrl(detailInfo.contractCreate)"
                    v-if="detailInfo.contractCreate">
                    {{ detailInfo.contractCreate }}
                  </router-link>
                  <span style="padding: 0 8px" v-if="detailInfo.contractCreate && detailInfo.contractCreateHash
                    ">
                    {{ $t('contract.transactionsIn') }}
                  </span>
                  <router-link class="normal ellipsis hash-width" :to="getTradeUrl(detailInfo.contractCreateHash)"
    ...
    <div class="address-trade gray-content content-padding">
      <div class="tabs">
        ...
        <el-button size="medium" :class="{ active: tabIndex == 2 }" @click="tabChange(2)">{{ $t('contract.erc20Trade')
        }}</el-button>
        <el-button size="medium" :class="{ active: tabIndex == 3 }" @click="tabChange(3)">{{ $t('contract.erc721Trade')
        }}</el-button>
        <!-- <el-button size="medium" :class="{ active: tabIndex == 4 }" @click="tabChange(4)">{{ $t('contract.erc1155Trade')
        }}</el-button> -->
      ...
      <!-- Erc1155 Token -->
      <erc1155-list v-show="tabIndex == 4" :address="address" :tradeCount="detailInfo"
        pageType="contractA"></erc1155-list>
      <!-- 委托 -->
