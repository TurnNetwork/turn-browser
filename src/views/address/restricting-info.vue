    ...
    <div class="restricting-detail-wrap">
        ...
        <div class="detail-change">
            <div class="detail-copy">
                ...
                <b class="cursor" :class="{ copy: !isCopy }" v-clipboard:copy="showAdr" v-clipboard:success="onCopy"
                    ...
                    <p v-show="isCopy"><i class="el-icon-circle-check-outline"></i><span>{{ copyText }}</span></p>
                </b>
                <a class="code cursor">
        ...
        <div class="restricting-detail">
            ...
            <List class="common-info">
                <Item :label="$t('contract.restrictedBalance')">
                    <p>{{ detailInfo.restrictingBalance | formatMoney }}&nbsp;TURN</p>
                </Item>
                <Item :label="$t('contract.forDelegations')">
                    <p>{{ detailInfo.stakingValue | formatMoney }}&nbsp;TURN</p>
                </Item>
                <Item :label="$t('contract.debt')">
                    <p>{{ detailInfo.underReleaseValue | formatMoney }}&nbsp;TURN</p>
                </Item>
            </List>
        </div>
        ...
        <div class="table restricted-table">
            ...
            <div class="restricted-total">
                ...
                <span>{{ detailInfo.totalValue | formatMoney }}&nbsp;TURN</span>
            </div>
            ...
            <div class="pagination-box">
                <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
                    ...
                    layout="sizes,total,  prev, pager, next" :total="pageTotal" :pager-count="9">
                </el-pagination>
            </div>
        </div>
    </div>
