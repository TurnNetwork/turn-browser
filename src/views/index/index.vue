<template>
  <div class="index-wrap" style="padding-bottom: 20px;">
    <vue-particles color="#2E2E2E" :particleOpacity="0.7" :particlesNumber="80" shapeType="circle" :particleSize="4"
      linesColor="#2E2E2E" :linesWidth="1" :lineLinked="true" :lineOpacity="0.7" :linesDistance="150" :moveSpeed="2"
      :hoverEffect="true" hoverMode="grab" :clickEffect="false" clickMode="repulse" class="lizi"
      :style="{ height: clientHeight + 'px' }"></vue-particles>
    <div class="welcome-wrap">
      <h3>
        {{ $t('indexInfo.WelcomeTo', { chain: '' }) }}
      </h3>
      <div class="search search-index" :class="{ 'search-active': isFocus, 'search-hide': !hideSearch }">
        ...
        <el-button type="primary" class="el-btn el-searchs" :class="{ 'search-btn-active': isFocus }" @click="searchFn"
      ...
      <el-col :span="12" class="bar-left bar">
        ...
        <ul class="block-statistics">
          <li class="statistics-link statistics-odd">
            ...
            <a class="cursor" @click="goBlockDetail(blockStatisticData.currentNumber)">{{ blockStatisticData.currentNumber
            }}</a>
          </li>
          ...
          <li class="statistics-odd">
            ...
            <el-progress class="progress-supply" :show-text="false" :percentage="blockStatisticData.turnValue
          ...
          <li class="statistics-even">
            ...
            <el-progress :show-text="false" :percentage="blockStatisticData.stakingDelegationValue
              | percentage(blockStatisticData.stakingDenominator)
              "></el-progress>
          </li>
        </ul>
        ...
        <div class="block-list-wrap">
          ...
          <ul class="blocks-ul blocks-ul-new" :class="{ 'blocks-active': isMove2 }">
            <li v-if="blockData.length">
              <div class="list-item">
                <span class="item-number cursor" @click="goBlockDetail(blockData[0].number)">{{ blockData[0].number
                }}</span>
                <p>
              ...
              <div class="list-item item-right">
                <span class="item-txns">{{ blockData[0].statTxQty }}&nbsp;{{
                  $t('indexInfo.txns')
                }}</span>
      ...
      <el-col :span="11">
        ...
        <div class="block-list-wrap">
          <ul class="node-ul" :class="{ 'node-animation': ValidatorData.dataList.length > 8 }">
            <li class="cursor" v-for="(item, index) in ValidatorData.dataList" :key="index"
              ...
              <div class="list-item item-left">
                ...
                <p>
                  ...
                  <a>{{ item.totalValue | formatMoney }}TURN</a>
                </p>
              </div>
              <div class="list-item item-right">
            ...
            <li class="cursor" v-for="item in showedValidatorData" :key="item.nodeId" @click="goNodeDetail(item.nodeId)">
              <div class="list-item item-left">
                <span class="item-number cursor">{{ item.nodeName }}</span>
                <p>
                  {{ $t('nodeInfo.totalStakePower') }}
