<template>
  <div class="contract-detail-wrap">
    <div class=" content-top-blackk contract-detail-top content-padding">
      ...
      <div class="detail-change">
        <div class="detail-copy">
          ...
          <i @click="goTokenDetail(detailInfo.contract, 'erc721')" style="cursor: pointer">{{ `${detailInfo.tokenName}
                      (${detailInfo.symbol})` | sliceStr(50) }}</i>
        </div>
      </div>
    ...
    <div class="address-trade gray-content content-padding">
      ...
      <tokens-trade-list v-show="activeTab == 1" :address="address" :tradeCount="detailInfo" table-type="erc721Id"
