<template>
  <div class="gray-content content-padding">
    <el-row class="history-validators-header" type="flex" justify="space-between"
    ...
    <div class="table node-table" v-if="type == 'history'" v-loading="tLoading">
      <div class="table-content">
        <el-table :data="tableData">
          <el-table-column :label="$t('common.serialnumber')" width="50" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.ranking }}</span>
            </template>
          </el-table-column>
          <el-table-column :label="$t('nodeInfo.name')" min-width="180">
            <!-- TODO历史节点 table -->
            <template slot-scope="scope">
          ...
          <el-table-column :label="$t('nodeInfo.pendingDelegations')" min-width="160">
            <template slot-scope="scope">
              <span>{{ scope.row.statDelegateReduction | formatMoney }} TURN</span>
            </template>
          </el-table-column>
          ...
          <el-table-column :label="$t('nodeInfo.name')" min-width="180">
            ...
            <template slot-scope="scope">
              <div class="flex-special validator-name">
                ...
                <router-link class="cursor normal ellipsis fontSize15" :to="getDetailUrl(scope.row.nodeId)">
                  {{ scope.row.nodeName ? scope.row.nodeName : '------' }}
                </router-link>
              </div>
            </template>
...
.validators-search {
  ...
  /*background: var(--Transparency-200, rgba(255, 255, 255, 0.06));*/
