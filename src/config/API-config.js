...
const BASE = process.env.VUE_APP_API_ROOT,
  FAUCET_BASE = process.env.VUE_APP_FAUCET_API_ROOT,
  ...
  MICRO_NODE_URL = `${TOTAL}/micronode`,
  ...
  //micro_NODE
  MICRO_NODE = {
    statistic: `${MICRO_NODE_URL}/statistic`,
    aliveNodeList: `${MICRO_NODE_URL}/aliveNodeList`,
    details: `${MICRO_NODE_URL}/microNodeDetails`,
    microNodeOptRecordList: `${MICRO_NODE_URL}/microNodeOptRecordList`,
  },
  // BLOCK
  BLOCK = {
  ...
  WS_CONFIG = {
    ...
    micronodestatistic: '/topic/micronode/statistic/new'
  },
  TOKEN = {
